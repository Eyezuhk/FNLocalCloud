...
schtasks /create /tn "FNLocalStartup" /tr "C:\Program Files (x86)\FNLocalFNLocal.exe" -sa %server_address% -sp %server_port% -lp %local_port% -bs %buffer_size% -p %protocol%" /sc ONSTART
